...
int main()
{
    ...
    {
        player.Input();
        player.Logic(pacman_map.Width, pacman_map.Height, pacman_map);
        Draw();
    }
}
...
void Setup()
{
    ...
    player.player_x = pacman_map.spawn_player.X;
    player.player_y = pacman_map.spawn_player.Y;
...
/*void Logic()
{
    ...
    {
        int player_y_new = player.player_y;
        int player_x_new = player.player_x;
        switch (input)
        {
        case UP:
            player_y_new--;
        ...
        case Map::MAP_TILES::MAP_WALL:
            player_y_new = player.player_y;
            player_x_new = player.player_x;
            break;
        ...
        player.player_y = player_y_new;
        player.player_x = player_x_new;
